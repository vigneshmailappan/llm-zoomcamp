...
vector vs martix : need for speed
    vector is a generic py list where as matrix is numpy array. numpy array stores elements continiously in mem but py list stores random place in mem. We convert to numpy array for speed.